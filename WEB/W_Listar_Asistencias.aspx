<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="W_Listar_Asistencias.aspx.cs" Inherits="WEB.W_Listar_Asistencias" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10 col-md-offset-1">
                                            <div class="card-content">
                                                ...
                                                <asp:GridView ID="GVAsistencia" runat="server" AutoGenerateColumns="False"
                                                    DataKeyNames="Apellidos,VTN_NombreTipoNivel,VN_NombreNivel,VU_Horario,DTA_Fecha,VA_EstadoAsistencia"
                                                    CssClass="table table-responsive table-bordered table-hover js-basic-example dataTable" PageSize="5"
                                                    AllowPaging="True" OnPageIndexChanging="GVAsistencia_PageIndexChanging" OnRowCommand="GVAsistencia_RowCommand"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="VA_EstadoAsistencia" HeaderText="Estado" />
