                            ...
                            <div class="header">
                             ...
                             <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        ...
                                        <asp:button runat="server" text="buscar" id="Button3" cssclass="col-lg-6 btn bg-indigo waves-effect" />
                                    </div>
                                 </div>
                            </div>
                        <div class="body table-responsive ">

                                <asp:GridView ID="gvConcurso" CssClass="table table-bordered table-hover js-basic-example dataTable" DataKeyNames="PK_IC_IdConcurs,VC_NombreCon" runat="server" AutoGenerateColumns="False" EmptyDataText="No existen registros" ShowHeaderWhenEmpty="True" OnRowCommand="gvConcurso_RowCommand">
                                    <Columns>
